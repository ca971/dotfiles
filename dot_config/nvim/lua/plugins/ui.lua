...
return {
	-- [[ STATUSLINE ]]
	{
		...
		opts = {
			options = {
				theme = Settings.active_colorscheme,

				section_separators = {
					left = Settings.section_separators_left,
					right = Settings.section_separators_right,
				},

				component_separators = {
					left = Settings.component_separators_left,
					right = Settings.component_separators_right,
				},
			},
		},
	},
